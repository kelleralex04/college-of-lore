...
export default function App() {
  ...
  function getCurSessionNote(noteId) {
    const curSessionNote = campaign.sessionNote.find((s) => s._id === noteId)
    ...
    <main className="App">
      { user ?
        <>
          ...
          <NavBar user={user} setUser={setUser} curCampaign={campaign} curCategory={category} setCurrentMain={setCurrentMain} setCategory={setCategory} />
          <div className='main-content'>
            <Routes>
              ...
              <Route path="/campaign/:campaignId" element={<HomePage campaign={campaign} setCampaign={setCampaign} category={category} setCategory={setCategory} 
                currentMain={currentMain} setCurrentMain={setCurrentMain} sessionNote={sessionNote} setSessionNote={setSessionNote} />} />
            </Routes>
          </div>
        </>
        :
